...
public abstract class KoreRecyclerViewAdapter<T, H extends KoreRecyclerViewAdapter.KoreViewHolder> extends RecyclerView.Adapter<H> {
    ...
    private KoreRecyclerViewAdapter.onItemClickListener<T> clickListener;
    ...
    public KoreRecyclerViewAdapter.onItemClickListener<T> getClickListener() {
        return this.clickListener;
    }

    public void addClickListener(KoreRecyclerViewAdapter.onItemClickListener<T> clickListener) {
    ...
    public static class EmptyViewHolder<T> extends KoreViewHolder<T> {
    ...
    public static abstract class KoreViewHolder<T> extends RecyclerView.ViewHolder {

        private Context context;
        private ViewDataBinding binding;

        public KoreViewHolder(View itemView) {
            super(itemView);
