package com.pixelatedleaft.kore.recyclerview;
...
import com.pixelatedleaft.kore.KoreFragment;
...
/**
 * @author juliancardona on 9/8/17.
 */

public abstract class KoreRecyclerViewFragment<M> extends KoreFragment {

    private boolean isHeaderEnabled;
    private boolean isLoadEnabled = true;
    private boolean isLoadMoreEnabled;
    private boolean isRefreshEnabled;
    private KoreRecyclerViewAdapter<M, KoreRecyclerViewAdapter.KoreViewHolder<M>> adapter;
    ...
    public void setAdapter(@NonNull KoreRecyclerViewAdapter<M, KoreRecyclerViewAdapter.KoreViewHolder<M>> adapter) {
        this.adapter = adapter;
    }

    public KoreRecyclerViewAdapter<M, KoreRecyclerViewAdapter.KoreViewHolder<M>> getAdapter() {
        return adapter;
    }
    ...
    protected @NonNull
    Consumer<Pair<List<M>, Boolean>> onLoadItemsSuccess() {
    ...
    protected @NonNull
    Consumer<Throwable> onLoadItemsFail() {
        return new Consumer<Throwable>() {
            @Override
            public void accept(Throwable throwable) throws Exception {
            }
     ...
     */
    protected abstract @NonNull
    Single<Pair<List<M>, Boolean>> getMoreItemsFromSource();

    protected @NonNull
    Consumer<Pair<List<M>, Boolean>> onLoadMoreItemsSuccess() {
        return new Consumer<Pair<List<M>, Boolean>>() {
            @Override
            public void accept(Pair<List<M>, Boolean> listBooleanPair) throws Exception {
    ...
    protected @NonNull
    Consumer<Throwable> onLoadMoreItemsFail() {
        return new Consumer<Throwable>() {
            @Override
            public void accept(Throwable throwable) throws Exception {
            }
    ...
    protected @NonNull
    Consumer<Pair<List<M>, Boolean>> onRefreshItemsLoadSuccess() {
        return new Consumer<Pair<List<M>, Boolean>>() {
            @Override
            public void accept(Pair<List<M>, Boolean> listBooleanPair) throws Exception {
            }
    ...
    protected @NonNull
    Consumer<Throwable> onRefreshItemsLoadFail() {
        return new Consumer<Throwable>() {
            @Override
            public void accept(Throwable throwable) throws Exception {
            }
